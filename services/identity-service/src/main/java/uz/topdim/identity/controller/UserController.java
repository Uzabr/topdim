...
public class UserController {
    ...
    @GetMapping("/me")
    public ResponseEntity<ApiResponse<UserProfileResponse>> getProfile(@RequestHeader("X-User-Id") Long userId) {
    ...
    public ResponseEntity<ApiResponse<List<FavoriteResponse>>> getFavorites(@RequestHeader("X-User-Id") Long userId) {
    ...
    public ResponseEntity<ApiResponse<FavoriteResponse>> addFavorite(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.success("Добавлено в избранное", favorite));
    }
