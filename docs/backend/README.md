...
Этот раздел для backend-разработчиков sizbiz. Внутреннее имя `topdim`
сохраняется в пакетах и инфраструктуре. Основной фокус: бизнес-инварианты,
безопасные статусные переходы, роли, транзакционность и тесты.
