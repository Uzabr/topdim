...
Для MVP этот гибридный контур является оптимальным: он не требует сложного конструктора купонов от мерчанта (создание красивой карточки остается на модераторах), но дает прозрачность статусов и контроль публикации.
