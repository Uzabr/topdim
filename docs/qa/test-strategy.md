...
> **Для ручного бизнес-тестирования (QA):** общий E2E описан в
> [manual-test-plan.md](manual-test-plan.md), а отдельная запусковая проверка
> админки — в [admin-launch-manual-test-plan.md](admin-launch-manual-test-plan.md).
